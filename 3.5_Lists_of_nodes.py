...
def test_remove_method():
    ...
    for i in range(10, 51, 10):
        mylist.append(i)
    val = mylist.remove(2)
    print(val, mylist,(str(f'{val} {mylist}') == '30 <DoublyLinkedList (4 elements): [10, 20, 40, 50]>'))

    mylist = DoublyLinkedList()
    for i in range(10, 51, 10):
        mylist.append(i)
    val = mylist.remove(0)
    print(val, mylist,(str(f'{val} {mylist}') == '10 <DoublyLinkedList (4 elements): [20, 30, 40, 50]>'))
    ...
    for i in range(10, 51, 10):
        mylist.append(i)
    val = mylist.remove(4)
    print(val, mylist,(str(f'{val} {mylist}') == '50 <DoublyLinkedList (4 elements): [10, 20, 30, 40]>'))
    ...
    try:
        ...
        print(mylist,(str(f'{mylist}') == '<DoublyLinkedList (0 elements): []>'))
    ...
    val = mylist.remove(0)
    val = mylist.remove(0)
    print(val, mylist,(str(f'{val} {mylist}') == '30 <DoublyLinkedList (0 elements): []>'))
    ...
    val = mylist.remove(1)
    val = mylist.remove(0)
    print(val, mylist,(str(f'{val} {mylist}') == '10 <DoublyLinkedList (0 elements): []>'))
