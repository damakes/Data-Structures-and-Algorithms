...
class Tree():
    ...
    def find_minimum(self):
        ...
        while current_node._left_child:
            current_node = current_node._left_child
        return current_node
    ...
    def find_maximum(self):
        ...
        while current_node._right_child:
            current_node = current_node._right_child
        return current_node
...
def test():
  ...
  print(minimum, maximum,(str(f'{minimum} {maximum}') == '10<><># 90<><>#')) #
  ...
  minimum = tree.find_minimum()
  maximum = tree.find_maximum()
  print(minimum, maximum,(str(f'{minimum} {maximum}') ==  '35<><># 50<35<><>#><>#'))

  tree = Tree()
  tree.insert(50)
  minimum = tree.find_minimum()
  maximum = tree.find_maximum()
  print(minimum, maximum,(str(f'{minimum} {maximum}') == '50<><># 50<><>#'))


  tree = Tree()
  minimum = tree.find_minimum()
  maximum = tree.find_maximum()
  print(minimum, maximum,(str(f'{minimum} {maximum}') == 'None None'))
test()
