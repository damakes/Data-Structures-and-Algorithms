...
class DoublyLinkedList:
    ...
    def insert(self, index, value):
        ...
        if index == 0:
            new_node = ListNode(value, next=self._head)
            if self._head:
        ...
        for _ in range(index):
            current_node = current_node.next
        new_node = ListNode(value, prev=current_node.prev, next=current_node)
...
def test_insert():
    ...
    for i in range(10, 51, 10):
        mylist.append(i)
    mylist.insert(0, 5)
    print(mylist, str(mylist) == "<DoublyLinkedList (6 elements): [5, 10, 20, 30, 40, 50]>")
    ...
    for i in range(10, 51, 10):
        mylist.append(i)
    mylist.insert(5, 60)
    print(mylist, str(mylist) == "<DoublyLinkedList (6 elements): [10, 20, 30, 40, 50, 60]>")
    ...
    for i in range(10, 51, 10):
        mylist.append(i)
    mylist.insert(2, 25)
    print(mylist, str(mylist) == "<DoublyLinkedList (6 elements): [10, 20, 25, 30, 40, 50]>")
    ...
    try:
        ...
        print(mylist, str(mylist) == "<DoublyLinkedList (5 elements): [10, 20, 30, 40, 50]>")
    else:
        print(mylist, False, "ValueError not raised for out of bounds index")
    ...
    mylist.insert(2, 25)
    mylist.insert(0, 5)
    print(mylist, str(mylist) == "<DoublyLinkedList (8 elements): [5, 10, 20, 25, 30, 40, 50, 55]>")
    ...
    mylist = DoublyLinkedList()
    mylist.insert(0, 5)
    print(mylist, str(mylist) == "<DoublyLinkedList (1 element): [5]>")
