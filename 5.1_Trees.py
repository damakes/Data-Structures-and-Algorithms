...
def test():
  ...
  tree.insert(30)
  tree.insert(35)
  find_tree = tree._find(35)
  print(find_tree,str(find_tree) == '35<><>#')
  ...
  tree.insert(30)
  tree.insert(35)
  find_tree = tree._find(10)
  print(find_tree,str(find_tree) == '10<><>#')
  ...
  tree.insert(30)
  tree.insert(35)
  find_tree = tree._find(20)
  print(find_tree,str(find_tree) == '20<10<><>#><40<30<><35<><>#>#><>#>#')
  ...
  find_tree = tree._find(50)
  print(find_tree,str(find_tree) == '50<20<10<><>#><40<30<><35<><>#>#><>#>#><70<><90<><>#>#>#')
  ...
  tree.insert(30)
  tree.insert(35)
  find_tree = tree._find(99)
  print(find_tree, str(find_tree) == 'None')
